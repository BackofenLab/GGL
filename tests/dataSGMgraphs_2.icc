#ifndef DATASGMGRAPHS_2_ICC_
#define DATASGMGRAPHS_2_ICC_
...
#include <boost/graph/properties.hpp>
	...
	MyGraph
	getPattern_2 (std::string& graphString) {
...
"\n=============================================\n";
	...
	MyGraph
	getPattern_2_WC (std::string& graphString) {
...
"\n=============================================\n";
	...
	getTarget_2 (std::string& graphString) {
		...
		// edge 0 - 2
		e = boost::add_edge(boost::vertex(0,t), boost::vertex(2,t), t).first;
		edgeLabel[e] = "-1-";
		// edge 0 - 2
		e = boost::add_edge(boost::vertex(0,t), boost::vertex(2,t), t).first;
		edgeLabel[e] = "-1-";
