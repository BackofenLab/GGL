...
#ifndef SGM_NSPDK_FLAGSSERVICE_H_
#define SGM_NSPDK_FLAGSSERVICE_H_
...
protected:
  ...
  static FlagsService * The_FlagsService;

public:

  static
  FlagsService& get_instance() {
	  if (The_FlagsService == NULL) {
		  The_FlagsService = new FlagsService();
	  }
	  return *The_FlagsService;
  }
