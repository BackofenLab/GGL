...
typedef long int SIZETYPE;  // SIZETYPE was 'int'
typedef unsigned long int node_id;
const node_id NULL_NODE = ULONG_MAX;
...
class ARGLoader
  { public:
      ...
      virtual node_id NodeCount() = 0;
      virtual void *GetNodeAttr(node_id node) = 0;
      virtual SIZETYPE OutEdgeCount(node_id node) = 0;
      virtual node_id GetOutEdge(node_id node, SIZETYPE i, void **pattr)=0;
  };
...
//      int n;              /* number of nodes  */  // CHANGED BY MARTIN MANN
    ...
    public:
      ...
      SIZETYPE InEdgeCount(node_id node);
      SIZETYPE OutEdgeCount(node_id node); 
      SIZETYPE EdgeCount(node_id node); 
      node_id GetInEdge(node_id node, SIZETYPE i);
      node_id GetInEdge(node_id node, SIZETYPE i, void **pattr);
      node_id GetOutEdge(node_id node, SIZETYPE i);
      node_id GetOutEdge(node_id node, SIZETYPE i, void **pattr);
...
class ARGraph: public ARGraph_impl
  { public:
      ...
      node_id GetInEdge(node_id node, SIZETYPE i, Edge **pattr)
                 { return ARGraph_impl::GetInEdge(node, i, (void**)pattr); }
      node_id GetOutEdge(node_id node, SIZETYPE i, Edge **pattr)
 ...
 * Number of nodes in the graph
 ----------------------------------------------*/
inline node_id ARGraph_impl::NodeCount() 
  { return n;
  } 
 ...
 * Number of edges going into a node
 ------------------------------------------------*/
inline SIZETYPE ARGraph_impl::InEdgeCount(node_id node) 
  { assert(node<n); 
 ...
 * Number of edges departing from a node
 ------------------------------------------------*/
inline SIZETYPE ARGraph_impl::OutEdgeCount(node_id node) 
  { assert(node<n); 
 ...
 * Number of edges touching a node
 ------------------------------------------------*/
inline SIZETYPE ARGraph_impl::EdgeCount(node_id node) 
  { assert(node<n); 
 ...
 * Gets the other end of an edge entering a node
 -----------------------------------------------*/
inline node_id ARGraph_impl::GetInEdge(node_id node, SIZETYPE i)
  { assert(node<n);
 ...
 * Gets the other end of an edge leaving a node
 -----------------------------------------------*/
inline node_id ARGraph_impl::GetOutEdge(node_id node, SIZETYPE i)
  { assert(node<n);
